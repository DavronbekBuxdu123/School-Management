    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full lg:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-green-500 text-white py-6 px-6 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
            ...
            <div className="w-2/3 flex flex-col  gap-4">
              ...
              <p className="text-sm text-white line-clamp-3">
                Bilim olishga intiluvchan va mas’uliyatli talaba. Darslarda faol
                ishtirok etadi hamda berilgan topshiriqlarni o‘z vaqtida
                bajaradi.
              </p>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[45%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Sinf</span>
              </div>
            </div>
          </div>
        </div>
